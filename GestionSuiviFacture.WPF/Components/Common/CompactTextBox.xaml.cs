...
{
    /// <summary>
    /// Interaction logic for CompactTextBox.xaml
    /// </summary>
    public partial class CompactTextBox : UserControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(CompactTextBox),
                new FrameworkPropertyMetadata(string.Empty, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault));

        public static readonly DependencyProperty PlaceholderTextProperty =
            DependencyProperty.Register("PlaceholderText", typeof(string), typeof(CompactTextBox),
                new PropertyMetadata("Enter text..."));

        public static readonly DependencyProperty IconSourceProperty =
            DependencyProperty.Register("IconSource", typeof(string), typeof(CompactTextBox),
