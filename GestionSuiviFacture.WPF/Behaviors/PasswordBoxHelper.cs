...
namespace GestionSuiviFacture.WPF.Behaviors
{
    ...
    {
        // Attached Properties for Placeholder functionality
        public static readonly DependencyProperty PlaceholderTextProperty =
            DependencyProperty.RegisterAttached("PlaceholderText", typeof(string), typeof(PasswordBoxHelper),
                new PropertyMetadata(string.Empty));

        public static readonly DependencyProperty IsAttachedProperty =
            DependencyProperty.RegisterAttached("IsAttached", typeof(bool), typeof(PasswordBoxHelper),
        ...
        // Event handler for when IsAttached changes
        ...
        // Set up the placeholder functionality
        ...
        private static void DetachPlaceholder(PasswordBox passwordBox)
        {
            ...
            {
                if (adorner is PasswordBoxPlaceholderAdorner)
        ...
        private static void UpdatePlaceholderVisibility(PasswordBox passwordBox)
        {
            ...
            foreach (var adorner in adorners)
            {
                ...
                {
                    placeholderAdorner.IsPlaceholderVisible = string.IsNullOrEmpty(passwordBox.Password);
                    adornerLayer.Update(passwordBox);
                }
            }
        }

        // Custom adorner for the placeholder text
        private class PasswordBoxPlaceholderAdorner : Adorner
        {
            ...
            protected override void OnRender(DrawingContext drawingContext)
            {
                ...
                // Calculate position for the placeholder text
